...
class TestHarness(implicit val p: Parameters) extends Module {
  ...
  dut.imoControllerIO.imo_out_ack := DontCare
  dut.imoControllerIO.imo_in_data := DontCare
  dut.imoControllerIO.imo_in_valid := Bool(false)

  //dut.outer.module.io.imo_out_ack := DontCare
  //dut.outer.module.io.imo_in_data := DontCare
  //dut.outer.module.io.imo_in_valid := Bool(false)
