...
trait HasRocketTiles extends HasTiles
    ...
    with HasPeripheryIMOController
...
trait HasRocketTilesModuleImp extends HasTilesModuleImp
  ...
  val imoControllerIO = IO(new Bundle {
...
class RocketSubsystemModuleImp[+L <: RocketSubsystem](_outer: L) extends BaseSubsystemModuleImp(_outer)
  ...
  imoControllerIO.imo_out_valid := outer.imoController.module.io.imo_out_valid
  outer.imoController.module.io.imo_out_ack := imoControllerIO.imo_out_ack
  imoControllerIO.imo_out_inst   := outer.imoController.module.io.imo_out_inst
  outer.imoController.module.io.imo_in_data := imoControllerIO.imo_in_data
  outer.imoController.module.io.imo_in_valid := imoControllerIO.imo_in_valid
