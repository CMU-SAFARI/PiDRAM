...
HD_PWD='/home/ataberk/EasyDRAM/controller-hardware/ZC706/Vivado_Project/E2E_RowClone.runs/rchip_axi4_xbar_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rchip_axi4_xbar.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rchip_axi4_xbar.tcl
