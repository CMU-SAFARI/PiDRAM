 ...
 * 64-byte burst [0,511]
 * @param bit3 the offset of the third RNG cell in the
 * 64-byte burst [0,511]
 * @param bit4 the offset of the fourth RNG cell in the
 * 64-byte burst [0,511]
 * @param boost_enable if the RNG should occupy scheduler
 * until the RN buffer is full
 */
