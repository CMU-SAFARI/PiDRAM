...
HD_PWD='/home/ataberk/EasyDRAM/controller-hardware/ZC706/Vivado_Project/E2E_RowClone.runs/rng_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rng_fifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rng_fifo.tcl
